...
const Skills = () => {
    return (
        <div>
            <h3 className='text-4xl text text-center font-bold'> My <span className='text-orange-400'>Skills</span></h3>
            <div className='mx-auto w-9/12 p-5 text-sky-400 rounded mb-4'>
                <p><span className='text-xl font-bold text-orange-400'>Expert:</span> Html, Html-5, CSS-3, Vanila CSS, Bootstrap, Tailwind CSS, Daisy UI, Javascript,
                    React.Js, Express.Js, MongoDb etc. <br />
                    <span className='text-xl font-bold text-orange-400'>Comfortable:</span> Node.Js, , Flowbite, Rest API, Next.js etc. <br />
                    <span className='text-xl font-bold text-orange-400'>Tools:</span> VS Code, Git, Netlify, Firebase, npm, Vercel,jwt, Chrome dev tools etc</p>
            </div>
