            ...
            <div className='md:flex gap-10'>
                <div className='w-1/2'>
                    <div>
                        ...
                        <input className='text-black p-3 rounded my-3 w-full' type="text" placeholder='your name' />
                    </div>
                    <div>
                        <h2 className='font-bold text-2xl uppercase'>Your Email</h2>
                        <input className='text-black p-3 rounded my-3 w-full' type="email" name="email" placeholder='your email' id="" />
                    </div>
                    <div>
                        <label className='font-bold text-2xl uppercase'>Your message</label>
                        <textarea className='w-full text-black p-5 rounded my-4' name="" placeholder='your message' id="" cols="20" rows="3"></textarea>
                    </div>
